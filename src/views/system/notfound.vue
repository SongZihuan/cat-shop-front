...
<template>
  <el-card class="base_card">
    ...
    >
      ...
      <template #extra>
        <el-button-group>
          <el-button v-if="!notWayToGo && isFromAdmin" type="info" size="large" @click="goAdmin">回到主页（{{ backSec > 5 ? 5 : backSec }}s）</el-button>
          <el-button v-else-if="!notWayToGo && !isFromAdmin" type="info" size="large" @click="goHome">回到主页（{{ backSec > 5 ? 5 : backSec }}s）</el-button>
